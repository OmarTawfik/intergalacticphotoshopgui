namespace IntergalacticCore.Operations.Morphology
{
    ...
    /// Erosion Operation
    /// </summary>
    public class ErosionOperation : ConvolutionBase
    {
        /// <summary>
        ...
        protected override void Operate()
        {
            unsafe
            {
                ...
                {
                    ErosionOperationExecute(this.GetCppData(this.Image), this.GetCppData(this.ResultImage), arrPointer, this.mask.Data.GetLength(1), this.mask.Data.GetLength(0));
                }
            }
        }
        ...
        private static unsafe extern void ErosionOperationExecute(ImageData src, ImageData dest, bool* mask, int maskWidth, int maskHeight);
    }
}
