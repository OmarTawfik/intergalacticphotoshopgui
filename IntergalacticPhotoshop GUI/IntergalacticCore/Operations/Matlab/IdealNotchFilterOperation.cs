namespace IntergalacticCore.Operations.Matlab
{
    ...
    /// <summary>
    /// Acts as a base for all notch pass filters.
    /// </summary>
    public abstract class IdealNotchFilterOperation : MatlabOperation
    {
        /// <summary>
        /// Matlab Class Handle.
        /// </summary>
        ...
        protected override void BeforeOperate()
        {
            ...
            for (int i = 0; i < this.Image.Height; i++)
            {
                for (int j = 0; j < this.Image.Width; j++)
                {
                    ...
                    double dnode = Math.Sqrt(x + y);
                    double passValue = this.GetPassValue(dnode, j, i);
        ...
        protected abstract double GetPassValue(double dnode, int x, int y);
    }
}
