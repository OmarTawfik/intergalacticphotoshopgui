...
{
    /// <summary>
    /// Performs a band pass filter with a cut-off frequency.
    /// </summary>
    public class IdealBandPassFilter : PassFilterOperation
    {
        /// <summary>
        ...
        {
            return (this.frequencyStart <= d && d <= this.frequencyEnd) ? 1 : 0;
        }
    }
}
