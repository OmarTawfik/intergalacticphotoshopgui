namespace IntergalacticCore.Operations.Matlab.PassFilters
{
    ...
    /// <summary>
    /// Performs an ideal notch pass filter with a specified notch radius and distance.
    /// </summary>
    public class IdealNotchPassFilter : IdealNotchFilterOperation
    {
        /// <summary>
        /// Frequency of filter.
        /// </summary>
        ...
        {
            return "Ideal Notch Pass Filter";
        }
